...
class AbuseReportsControllerTest < ActionController::TestCase
  ...
  test "should create abuse_report" do
    assert_difference('AbuseReport.count') do
      post :create, abuse_report: { article_id: @abuse_report.article_id, description: @abuse_report.description, title: @abuse_report.title }
    end
  ...
  test "should update abuse_report" do
    patch :update, id: @abuse_report, abuse_report: { article_id: @abuse_report.article_id, description: @abuse_report.description, title: @abuse_report.title }
    assert_redirected_to abuse_report_path(assigns(:abuse_report))
  end
